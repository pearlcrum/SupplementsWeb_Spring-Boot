...
public class BbsDaoImpl2 implements BbsDao2{

	Connection conn=null;
	
	public BbsDaoImpl2(Connection conn) {
		this.conn=conn;
	}
	...
	public ArrayList<BbsVo2> searchByBBSTitle(String searchText, int pageNumber){
		ArrayList<BbsVo2> list = new ArrayList<BbsVo2>();
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
	...
	public ArrayList<BbsVo2> searchByUserID(String searchText, int pageNumber){
		ArrayList<BbsVo2> list = new ArrayList<BbsVo2>();
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
	...
	public ArrayList<BbsVo2> searchByBBSContent(String searchText, int pageNumber){
		ArrayList<BbsVo2> list = new ArrayList<BbsVo2>();
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
