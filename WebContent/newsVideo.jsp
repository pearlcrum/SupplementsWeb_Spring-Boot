	...
	<td class="info-bg">
			...
			<div class="container">
				<div class="row">
					...
					<tbody>
						<tr>
							<th class="table-style-5"> 영양제 관련 뉴스 </th>
							<th class="table-style-5"> 영양제 관련 비디오 </th>
							</tr>
							<tr>
							<td class="table-style-4"> <iframe src="childNews.jsp" height="1150" width="600"  frameborder=0 framespacing=0 marginheight=0 marginwidth=0 marginleft=100px; scrolling=yes vspace=0>></iframe> </td>	
							<td class="table-style-4"> <iframe src="childVideo.jsp" height="1150" width="600"  frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=yes vspace=0>></iframe> </td>
						</tr>
					</tbody>
					</table>
				</div>
