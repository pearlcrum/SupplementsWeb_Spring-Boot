...
<%@ page import ="com.biz.BbsBiz2" %>
<%@ page import ="com.vo.BbsVo2" %>
...
<body>
	...
	<nav class="navbar navbar-default">
		...
		<li><a href="main.jsp">메인</a></li>
				...
				<li class="active"><a href="bbs2.jsp">Q&A 게시판</a>
					</li>
		...
		<div class="row">
			<table class="table table-striped">
				...
				<tbody>
					...
					ArrayList<BbsVo2> list = bbsBiz.getBBSByPage(pageNumber);
				...
				%>
					...
					<tr>
						...
						<td class="table-style-6"><a href="view2.jsp?bbsID=<%= list.get(i).getBbsID() %>"><%= list.get(i).getBbsTitle() %></a></td>
			...
			<%
					...
					BbsBiz2 bbsBiz = new BbsBiz2();
					ArrayList<BbsVo2> list = (ArrayList<BbsVo2>)request.getAttribute("searchAns");
					for(int i = 0; i <list.size(); i++){
			...
			<form method="post" action="search2">
				<div class="search-all">
					...
					<input class="search" type="text" placeholder="내용을 적어주세요"
						name="searchText">
				</div>
				<a href="write2.jsp" class="btn btn-primary">글쓰기</a>
			</form>
		</div>
	</div>
