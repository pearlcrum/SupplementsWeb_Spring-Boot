 ...
 <%
  ...
  %>
	...
	<div class="row">
		...
		<thead>
			<tr>
				<th colspan="3" class="view-tit2">게시판 글 보기</th>
				</tr>
				</thead>
				<tbody>
				<tr>
					<td class="table-style-1" style="width: 20%;">제목</td>
					<td class="table-style-4" colspan= "2"><%= bbsVo.getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
							.replaceAll("\n", "<br>") %></td>
				</tr>
					<tr>
					<td class="table-style-1" style="width: 20%;">작성자</td>
					<td class="table-style-4" colspan= "2"><%= bbsVo.getUserID() %></td>
				</tr>
				<tr>
					<td class="table-style-1" style="width: 20%;">작성일</td>
					<td class="table-style-4" colspan= "2"><%= bbsVo.getBbsDate().substring(0, 11) + bbsVo.getBbsDate().substring(11, 13) + "시" + bbsVo.getBbsDate().substring(14, 16) + "분"%></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="table-style-4" colspan="2" style="min-height: 200px; text-align: justify;"><%= bbsVo.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
					.replaceAll("\n", "<br>")%></td>
				</tr>
				</tbody>
				</table>
		...
		<div class="container" style="background-color: #FCF6F5; border: 2px solid #7b9acc;">
			...
			<input type="hidden" class="a" placeholder="유저ID" name="userID" value="<%=userID%>">
     		<textarea type="text" class="form-control" class="a" placeholder="댓글을 입력하세요" name="comment2" maxlength="100" rows="3"></textarea>
	...
	<table class="table table-striped">
		<thead>
			<tr>
				<th class="view-tit2" colspan="4" >댓글 보기</th>
			</tr>
			</thead>
			<tbody>
			<tr>
